package com.undefinedlabs.nikeriposteintegration.functionaltest;
...
public class PropertiesHelper {
    ...
    public final String nikeriposteintegrationHost;
    public final String basicAuthHeaderVal;

    @Inject
    private PropertiesHelper(
        @Named("nikeriposteintegration.host") String nikeriposteintegrationHost,
        @Named("basicAuth.username") String basicAuthUsername,
        @Named("basicAuth.password") String basicAuthPassword
    ) {
        this.nikeriposteintegrationHost = nikeriposteintegrationHost;
    ...
    private static PropertiesHelper generateInstance() {
        String appId = "nike-riposte-integration-functionaltest";
